 ...
 */
public class SwitchController_Jaguar implements SpeedController, IDeviceController, PIDOutput, LiveWindowSendable {
	
	private final Jaguar motor;
	private final ILimitSwitchSystem switchSystem;
	
	public SwitchController_Jaguar(Jaguar motor, ILimitSwitchSystem switchSystem){
		this.motor = motor;
